...
import de.domenikyt1.createdomeniksmod.register.item.*;
...
public class CDMItems {
    ...
    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_COOLTENDO_SWATCH =
            REGISTRATE.item("incomplete_cooltendo_swatch", SequencedAssemblyItem::new).register();

    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_CIRCUIT_BOARD =
            REGISTRATE.item("incomplete_circuit_board", SequencedAssemblyItem::new).register();
    ...
    public static final ItemEntry<Item> CIRCUIT_BOARD =
            REGISTRATE.item("circuit_board", Item::new).tag(CDMTags.Items.PLATES_CIRCUIT).register();
