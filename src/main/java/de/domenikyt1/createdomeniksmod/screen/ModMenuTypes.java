package de.domenikyt1.createdomeniksmod.screen;

import de.domenikyt1.createdomeniksmod.CDM;
import de.domenikyt1.createdomeniksmod.screen.custom.PedestalMenu;
import de.domenikyt1.createdomeniksmod.screen.custom.SidePedestalMenu;
...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(Registries.MENU, CDM.MOD_ID);
