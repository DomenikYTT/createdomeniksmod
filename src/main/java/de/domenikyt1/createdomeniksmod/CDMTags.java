...
public class CDMTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> CREATE_WRENCHES = NeoTag("create_wrenches");
        public static final TagKey<Item> PLATES_CIRCUIT = NeoTag("plates/circuit");
