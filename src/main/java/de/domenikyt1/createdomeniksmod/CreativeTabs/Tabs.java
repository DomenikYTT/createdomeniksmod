...
public class Tabs {
    public static final DeferredRegister<CreativeModeTab> TAB = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Createdomeniksmod.MOD_ID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BLOCKS_TAB = TAB.register("tab_blocks", () -> CreativeModeTab.builder().title(Component.translatable("tab.blocks")).withTabsBefore(CreativeModeTabs.COMBAT).icon(() -> ModBlocks.FIRE_CASING.get().asItem().getDefaultInstance()).displayItems((parameters, output) -> {
        ...
        output.accept(ModBlocks.FIRE_CASING.get());
    }).build());
}
