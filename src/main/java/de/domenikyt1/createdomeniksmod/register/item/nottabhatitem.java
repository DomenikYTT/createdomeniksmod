...
public class nottabhatitem extends Item implements Equipable {

    protected ResourceLocation HAT_LOCATION;


    public nottabhatitem(String hatLocation, Properties properties, Supplier<ItemAttributeModifiers> defaultModifiers) {
        this(ResourceLocation.fromNamespaceAndPath(CDM.MOD_ID, hatLocation), properties);
        this.defaultModifiers = defaultModifiers;
    }

    public nottabhatitem(ResourceLocation hatLocation, Properties properties) {
        super(properties);
    ...
    public nottabhatitem(Item.Properties p_40388_) {
        super(p_40388_);
