package de.domenikyt1.createdomeniksmod.register.screen;
...
import de.domenikyt1.createdomeniksmod.CDMMenuTypes;
...
public class PedestalMenu extends AbstractContainerMenu {
    ...
    public PedestalMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        super(CDMMenuTypes.PEDESTAL_MENU.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, CDMBlocks.SACRIFICE_ALTAR.get());
    }
